...
$('#sponsorsSlick').slick({
	...
	slidesToShow : 5,
	slidesToScroll:5,
	prevArrow:"<button type='button' class='slick-prev'><img  src='https://cci-tnt.s3.amazonaws.com/2018/assets/img/slick-left.png'></button>",
    nextArrow:"<button type='button' class='slick-next'><img  src='https://cci-tnt.s3.amazonaws.com/2018/assets/img/slick-right.png'></button>",
	responsive : [
...
$('#featureSlick').slick({
	...
	slidesToShow : 1,
	slidesToScroll : 1,
	prevArrow:"<button type='button' class='slick-prev'><img  src='https://cci-tnt.s3.amazonaws.com/2018/assets/img/slick-left-light.png'></button>",
    nextArrow:"<button type='button' class='slick-next'><img  src='https://cci-tnt.s3.amazonaws.com/2018/assets/img/slick-right-light.png'></button>",
    responsive: [
	    {
	      breakpoint: 480,
	      settings: {
...
$('#gallerySlick').slick({
		dots : true,
		arrows:true,
		prevArrow:"<button type='button' class='slick-prev'><img  src='https://dpqk9jykiwrgy.cloudfront.net/2019/assets/img/slick-left-light.png'></button>",
	    nextArrow:"<button type='button' class='slick-next'><img  src='https://dpqk9jykiwrgy.cloudfront.net/2019/assets/img/slick-right-light.png'></button>",
		slidesToShow: 1,
		slidesToScroll: 1,
		responsive: [
		    {
